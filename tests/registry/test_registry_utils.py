...
class MockRequest:
    ...
    def __init__(self, service_type=None, api_version=None, service_id=None):
        """Initialise object."""
        self.query = {"type": service_type, "apiVersion": api_version}
        self.match_info = {"service_id": service_id}
...
class TestUtils(asynctest.TestCase):
    ...
    async def test_parse_service_info_beacon(self):
        ...
        service_info = {
            ...
            "name": "Finnish Beacon",
            "description": "Finnish Data",
            "organization": {"name": "CSC", "welcomeUrl": "https://csc.fi/", "contactUrl": "https://csc.fi/contact", "logoUrl": "https://csc.fi/logo.png"},
            "apiVersion": "1.0.0",
            "version": "1.0.0",
        }
    ...
    async def test_construct_json(self):
        ...
        expected_format = {
            ...
            "type": {"group": "org.ga4gh", "artifact": "beacon", "version": "1.0.0"},
            "description": "Finnish Data",
            "organization": {"name": "CSC", "url": "https://csc.fi/", "logoUrl": "https://csc.fi/logo.png"},
            "contactUrl": "https://csc.fi/contact",
            "createdAt": "2019-09-01T12:00:00Z",
            "updatedAt": "2019-09-01T12:00:00Z",
            "environment": "prod",
    ...
    async def test_query_params_all(self):
        ...
        request = MockRequest(service_type="beacon", api_version="1.0.0", service_id="fi.beacon")
        service_id, params = await query_params(request)
        self.assertEqual(service_id, "fi.beacon")
        self.assertEqual(params, {"type": "beacon", "apiVersion": "1.0.0"})
    ...
    async def test_get_service_urls_found(self):
        ...
        connection = Connection(return_value=[{"service_url": "https://beacon1.fi/"}, {"service_url": "https://beacon2.fi/"}])
    ...
    async def test_get_recaching_credentials_found(self):
        ...
        connection = Connection(return_value=[{"url": "https://beacon1.fi", "service_key": "abc123"}, {"url": "https://beacon1.fi", "service_key": "abc123"}])
    ...
    async def test_invalidate_cache_success(self, m_resp, m_log):
        ...
        service = {"service_url": "https://aggregator.csc.fi/service-info", "service_key": "secret"}
    ...
    async def test_invalidate_cache_fail(self, m_resp, m_log):
        ...
        service = {"service_url": "https://aggregator.csc.fi/service-info", "service_key": "wrongkey"}
    ...
    async def test_invalidate_cache_error(self, m_resp, m_log):
        ...
        service = {"service_url": "https://aggregator.csc.fi/service-info"}
        m_resp.delete("https://aggregator.csc.fi/cache", status=200)
