...
def generate_beacon_network_jwt(issuer: str, other_sites: [str], cilogon_decoded: any, target_private_key: Ed25519PrivateKey, target_kid: str):
    ...
    new_jwt_token = jwt.encode(payload,
                               target_private_key,
                               algorithm='EdDSA',
...
def test_beacon_network_jwt_create_and_decode():
    jwt = generate_beacon_network_jwt("https://fake.site.com", ["https://fake2.site.com"],
                                      {'sub': 'http://cilogon.org/serverA/users/46001501',
                                       'iss': 'https://test.cilogon.org',
                                       'groups': ['CO:members:all', 'CO:members:active',
                                                  ...
                                                  'OIDC mgrs', 'CO:admins'], 'given_name': 'Andrew',
                                       'aud': 'cilogon:/client_id/2f3284e8fb5c3d3d956448c316aec43c',
                                       'auth_time': 1685325378, 'name': 'Andrew Patterson',
                                       'exp': 1685326279, 'family_name': 'Patterson', 'iat': 1685325379,
